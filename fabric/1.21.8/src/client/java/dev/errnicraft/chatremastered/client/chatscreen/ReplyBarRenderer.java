...
public final class ReplyBarRenderer {
    ...
    public static void renderReplyOverMessage(GuiGraphics graphics, Minecraft mc, ChatScreen self, int mouseX, int mouseY,
        ...
        if (replyImageId != null) {
            ResourceLocation tex = ImageCache.getTexture(replyImageId);
            if (tex != null) {
                String arrowStr = "↩ ";
        ...
        graphics.drawString(mc.font, truncateFormatted(mc, full, maxW),
